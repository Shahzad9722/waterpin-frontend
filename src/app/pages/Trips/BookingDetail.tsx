...
export function BookingDetail(props:Props) {
                        ...
                        <div className="detail-body">
                          <Grid container spacing={2}>
                            <Grid item xs={12} sm={12} md={12} lg={6}>
                                  <img className="user-img" src={props.trip?.renter?.profileImage} />
                                  <span className="user-name">{props.trip?.renter?.firstName} {props.trip?.renter?.lastName}</span>
                                  <div className="contact">
                                      <div className="email">
                                          <img src={iconmsg} />
                                          <span>{props.trip?.renter?.email}</span>
                                      </div>
                                      <div className="phone">
                                          <img src={iconphone} />
                                          <span>{props.trip?.renter?.phoneNumber}</span>
                                      </div>
                                  </div>
                                  ...
                                  <div className="bottom-card">
                                      ...
                                      <div className="question-sec">
                                          ...
                                          <span className="ans">Get in contact with the renter to confirm boarding instructions & any further accommodations.</span>

                                          <span className="question">When do I get my security deposit back?</span>
                                          <span className="ans">We hold your security deposit up to 24 hours post charter start time. If issues occur, we can hold the deposit, investigate, and resolve the issue. <br/><br/>Once resolved, either you or the renter will get the deposit. Always be sure to save messages to support your claim. </span>
                                      </div>
                                  </div>
                            </Grid>
                            <Grid item xs={12} sm={12} md={12} lg={6}>
