...
export function SignUp(props: Props) {
  ...
  const [countryCode, set_countryCode] = React.useState('');
  const [signupWithEmail, set_signupWithEmail] = React.useState(false);
  const [signupWithPhoneNumber, set_signupWithPhoneNumber] =
    React.useState(true);
  ...
  React.useEffect(() => {
    if (
      ...
      //setTimeout(() => history.push('/dashboard?welcome=true'), 2000);
    }
  }, [signupSuccess]);
  ...
  function handleSignup(e: any) {
    ...
    if (password !== confirm_password) {
      set_errorMsg("Passwords do not match, please confirm again.")
    ...
    >
      <Box sx={style}>
        ...
        <ModalBody>
          ...
          <br />
          <Label style={{color:"red"}}>{errorActive && errorMsg}</Label>
          <ContinueButton onClick={e => handleSignup(e)}>
            {loading ? (
              <CircularProgress
                size={30}
                sx={{
            ...
            <Box width={'50%'} pr={2}>
              {signupWithEmail ? (
                <SSOButton
                  ...
                  onClick={() => {
                    set_signupWithPhoneNumber(true);
                    set_signupWithEmail(false);
                  }}
                >
                ...
                <SSOButton
                  ...
                  onClick={() => {
                    set_signupWithPhoneNumber(false);
                    set_signupWithEmail(true);
                  }}
                >
                  Sign Up With Email
                </SSOButton>
